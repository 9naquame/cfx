        ...
        foreach($this->data as $i => $row)
        {
            ...
            if($this->operations!=null)
            {
                ...
                foreach($this->operations as $operation)
                {
                    $rowOperations .=
                        sprintf(
                            '<a class="tapi-icon tapi-iaction tapi-i%s tapi-operation tapi-operation-%s" href="%s">%s</a>',
                            $operation['link'],
                            $operation["link"],
                            str_replace(array("%key%","%path%"),array($key,$operation["link"]),$operation["action"]),
                            $operation["label"]
                        );
                }
            }
